...
class usuarios extends CI_Controller
{
     ...
     public function nuevo(){
		...
		if($this->form_validation->run() == TRUE){
			   ...
			   $VerifyExist = $this->model_usuarios->ExisteUser($this->input->post("USUARIO"));
               if($VerifyExist==0){
			   ...
			   if($VerifyExist>0){
					...
					$this->load->view('layout/panel/menu');
					$this->load->view('layout/panel/PanelAdmi');
					$this->load->view('layout/panel/view_nuevo_usuario');
					$this->load->view('layout/panel/footer');

                    //$this->load->view('layout/login/header');
					//$this->load->view('layout/otras/view_nuevo_usuario');
	 ...
	 public function editar($id = NULL){
		...
		if ($this->input->post()) {
			...
			if (empty($data['datos_usuarios'])){
			    ...
			    $this->load->view('layout/panel/menu');
		        $this->load->view('layout/panel/PanelAdmi');
				$this->load->view('layout/panel/view_nuevo_usuario',$data);
				$this->load->view('layout/panel/footer');
			}
		}
	...
	public function eliminar($id = NULL){
		...
		if ($this->input->post()) {
			...
			if (empty($data['datos_usuarios'])){
			    ...
			    $this->load->view('layout/panel/menu');
		        $this->load->view('layout/panel/PanelAdmi');
				$this->load->view('layout/panel/view_delete',$data);
				$this->load->view('layout/panel/footer');
			}
		}
	}
		...
		if ($this->input->post()) {
			...
			if ($this->form_validation->run() == TRUE){
				...
				if($password==$password1){
			        ...
			        $this->load->view('layout/panel/menu');
		            $this->load->view('layout/panel/PanelAdmi');
					$this->load->view('layout/panel/view_password',$data);
					$this->load->view('layout/panel/footer');
				}
			}else{
				$this->load->view('layout/panel/header');
	   ...
	   if ($id == NULL OR !is_numeric($id)){
		...
		if ($this->input->post()) {
			...
			if (empty($data['datos_usuarios'])){
			    ...
			    $this->load->view('layout/panel/menu');
		        $this->load->view('layout/panel/PanelAdmi');
				$this->load->view('layout/panel/view_permisos',$data);
				$this->load->view('layout/panel/footer');
			}
		}
