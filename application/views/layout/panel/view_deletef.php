...
?><div id="container">
	...
	echo form_open();
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>Eliminar Información de ".$datos_funcionarios[0]->NOMBRE.' '.$datos_funcionarios[0]->APELLIDO."</legend></td>";
	  echo '</tr>';
