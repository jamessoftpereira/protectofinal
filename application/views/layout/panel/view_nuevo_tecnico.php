<?php
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='tabla_ventanas_login' height='10' colspan='3'><legend align='center'>.: Nuevo Tecnico :.</legend></td>";
	  echo '</tr>';
	  echo '<tr><td colspan=3>';
	  $attributes = array("class" => "form-horizontal", "id" => "form", "name" => "form" , "method" => "POST");
	...
	'id'          => 'CEDULA',
	'size'        => 50,
	'value'		  => set_value('CEDULA',@$datos_tecnicos[0]->CEDULA),
	'placeholder' => 'Cedula',
	'type'        => 'text',
	);
	echo '<tr>';
	...
	'id'          => 'NOMBRE',
	'size'        => 50,
	'value'		  => set_value('NOMBRE',@$datos_tecnicos[0]->NOMBRE),
	'placeholder' => 'Nombre',
	'type'        => 'text',
	);
	echo '<tr>';
	...
	'id'          => 'APELLIDO',
	'size'        => 50,
	'value'		  => set_value('APELLIDO',@$datos_tecnicos[0]->APELLIDO),
	...
	'id'          => 'EMAIL',
	'size'        => 50,
	'value'		  => set_value('EMAIL',@$datos_tecnicos[0]->EMAIL),
	'placeholder' => 'Email',
	'type'        => 'text',
	);
	echo '<tr>';
	...
	'id'          => 'CARGO',
	'size'        => 50,
	'value'		  => set_value('CARGO',@$datos_tecnicos[0]->CARGO),
	'placeholder' => 'Cargo',
	'type'        => 'text',
	);
	echo '<tr>';
