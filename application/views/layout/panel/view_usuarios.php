...
<tbody>
 ...
 if(!empty($usuarios)){
  foreach($usuarios as $usuario){
    ...
    echo '<td>'
?>
    <a href="<?php echo base_url();?>index.php/usuarios/editar/<?php echo $usuario->ID;?>/" class="btn btn-success"><spam class="glyphicon glyphicon-edit"></spam></a>
    <a href="<?php echo base_url();?>index.php/usuarios/password/<?php echo $usuario->ID ?>" class="btn btn-default"><spam class="glyphicon glyphicon-lock"></spam></a>
    <a href="<?php echo base_url();?>index.php/usuarios/permisos/<?php echo $usuario->ID;?>" class="btn btn-info"><spam class="glyphicon glyphicon-ok"></spam></a>
    <a href="<?php echo base_url();?>index.php/usuarios/eliminar/<?php echo $usuario->ID ?>" class="btn btn-danger"><spam class="glyphicon glyphicon-trash"></spam></a>
